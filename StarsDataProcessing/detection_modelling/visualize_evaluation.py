...
dataset_folder = "/home/stars/Code/carla_utils/new_output_test_data/19 April/SVD_Data/round_5"#11

  # folder with raw images and annotations
checkpoints_path = "/home/stars/Code/carla_utils/training/final_training/output/model_final.pth"
...
def main():
    ...
    evaluator = evaluation.prepareEvaluator(
        confidence_thres=confidence_thres, iou_thres=iou_thres, chkpts_file=checkpoints_path,
    )
    ...
    for result in evaluator.evaluateDatasetIterative(round_x_dataset):
        ...
        if (fps>0):
            ...
            print(f"Vehicle: Precision = {100*p_vehicle:.2f}%; Recall = {100*r_vehicle:.2f}%;")
